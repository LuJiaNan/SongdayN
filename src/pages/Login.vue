    ...
    <div class="align">
      <div class="grid">
        <div class="loginForm" v-if="showLogin">
          ...
          <p class="text--center">
            Not a member?
            <a v-on:click="changeForm('register')">Sign up now</a>
            <svg class="icon">
              <use
        ...
        <div class="registerForm" v-if="!showLogin">
          <div class="form sign">
            ...
            <div class="form__field">
              ...
              <input
                id="login__password_forsure"
                type="password"
                name="password_forsure"
                v-model="password_forsure"
                class="form__input"
                placeholder="Password_Forsure"
                required
              />
            </div>
            <div class="form__field">
          ...
          <p class="text--center">
            Is a member?
            <a v-on:click="changeForm('sign')">Sign in now</a>
            <svg class="icon">
              <use
                xmlns:xlink="http://www.w3.org/1999/xlink"
                xlink:href="assets/images/icons.svg#arrow-right"
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      const findUser = userArr =>
        userArr.find(user => user.username === this.username);
