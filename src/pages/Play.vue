        ...
        <div class="bottomPlayer">
          <div class="playerBlock">
            <div class="player-controls">
              <div class="prev-btn" v-on:click="playPrev"><i class="el-icon-caret-left"></i></div>
              <div class="play-btn" v-on:click="play"><i v-bind:class="[playStatus ? 'el-icon-video-pause' : 'el-icon-video-play']"></i></div>
              <div class="next-btn" v-on:click="playNext"><i class="el-icon-caret-right"></i></div>
